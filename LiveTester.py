...
class LiveXSSTester:
    ...
    def append_to_file(self, data, filename=PARAMETERS_OUTPUT_FILE):
        with open(filename, "a", encoding="utf-8") as f:
            f.write("# Generated by ParamSpyV0.5. For authorized pentesting only.\n")
            json.dump(data, f)
            f.write("\n")
    ...
    def setup_navigation_driver(self):
        ...
        chrome_options.add_argument("--ignore-certificate-errors")  # Bypass certificate errors
    ...
    def fetch_page_content_selenium_get(self, url, payload):
        try:
            response = requests.head(url, timeout=5, verify=False)  # Disable SSL verification for rate limiting check
